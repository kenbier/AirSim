...
namespace AirSimUnity {
    ...
    public struct ImageRequest {
        ...
        public ImageRequest(int camera_id, ImageType image_type, bool pixels_as_float, bool compress) {
    ...
    public struct ImageResponse {
        ...
        public ImageResponse(List<byte> imageDataInt, List<float> imageDataFloat, int camera_id,
